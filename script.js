...
const defaultLibrary = [
    ...
    { emoji: '🚿', name: 'Bruser' },
    { emoji: '🚽', name: 'Toilet' },
    { emoji: '🧻', name: 'Toiletpapir' },
    { emoji: '🧼', name: 'Sæbe' },
    { emoji: '🧽', name: 'Svamp' },
    { emoji: '🪥', name: 'Tandbørste' },
    { emoji: '🪒', name: 'Barbering' },
    { emoji: '🧺', name: 'Vasketøj' },
    { emoji: '🧹', name: 'Kost' },
    { emoji: '🧴', name: 'Shampoo' },
    { emoji: '🗑️', name: 'Skrald' },
    { emoji: '♻️', name: 'Genbrug' },
    { emoji: '🔑', name: 'Nøgle' },
    { emoji: '🔒', name: 'Lås' },
    { emoji: '🔓', name: 'Lås op' },
    { emoji: '💡', name: 'Ide' },
    ...
    { emoji: '✏️', name: 'Blyant' },
    { emoji: '🖊️', name: 'Pen' },
    { emoji: '🖍️', name: 'Farveblyant' },
    { emoji: '✂️', name: 'Saks' },
    { emoji: '🧷', name: 'Sikkerhedsnål' },
    { emoji: '📎', name: 'Papirclips' },
    { emoji: '📌', name: 'Tegn nål' },
    { emoji: '🧮', name: 'Lommeregner' },
    { emoji: '🧑‍🏫', name: 'Lærer' },
    { emoji: '🧑‍🎓', name: 'Elev' },
    { emoji: '🎒', name: 'Rygsæk' },
    { emoji: '🗂️', name: 'Arkiv' },
    ...
    { emoji: '🔔', name: 'Klokke' },
    { emoji: '🔕', name: 'Lydløs' },
    { emoji: '💼', name: 'Arbejdstaske' },
    { emoji: '🧰', name: 'Værktøj' },
    { emoji: '🔧', name: 'Skruenøgle' },
    { emoji: '🔨', name: 'Hammer' },
    { emoji: '🪛', name: 'Skruetrækker' },
    { emoji: '🪚', name: 'Sav' },
    { emoji: '⚙️', name: 'Tandhjul' },
    { emoji: '🧯', name: 'Brandslukker' },
    { emoji: '🔥', name: 'Ild' },
    { emoji: '🧊', name: 'Is' },
    { emoji: '💧', name: 'Vand' },
    { emoji: '🍽️', name: 'Middag' },
    ...
    { emoji: '🧑‍⚕️', name: 'Læge' },
    { emoji: '🧑‍🍳', name: 'Kok' },
    { emoji: '🧑‍🔧', name: 'Mekaniker' },
    { emoji: '🌤️', name: 'Let sol' },
    { emoji: '☀️', name: 'Sol' },
    { emoji: '🌧️', name: 'Regn' },
    { emoji: '⛈️', name: 'Torden' },
    { emoji: '🌨️', name: 'Sne' },
    ...
    { emoji: '🦆', name: 'And' },
    { emoji: '🐝', name: 'Bi' },
    { emoji: '🦋', name: 'Sommerfugl' },
    { emoji: '🐞', name: 'Mariehøne' },
    { emoji: '⭐', name: 'Stjerne' },
    { emoji: '✨', name: 'Gnister' },
    { emoji: '⚡', name: 'Lyn' },
    { emoji: '🎈', name: 'Ballon' },
